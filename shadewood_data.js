...
const factionData = {
    ...
    "skydancers": {
        ...
        roster: [
            { id: "starwing", name: "Queen", role: "Leader", tags: ["Leader"], ability: { name: "Wings of Freedom", desc: "Friendly Skydancer operatives can teleport between fairy rings without spending an Action Point (this still counts as a major movement)." }, special: { name: "Command", cost: "0", desc: "Once per battle, during this operative's activation, for free, you can command a friendly operative from your faction to complete 1 free Generic Action. If that action would make that friendly unit move, it can only move a maximum of 2 hexes." }, stats: { hp: 7, def: 4, acc: "4+", move: 7, al: 2 }, weapons: [{name: "Sky Rifle", atk: 4, acc: "4+", rng: 12, pwr: "2/4", sr: "-"}, {name: "Wind Rapier", atk: 4, acc: "4+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            ...
            { id: "gunner_starfire", name: "Aerial Gunner (Starfire)*", role: "Operative", tags: ["Gunner"], ability: { name: "Aerial Superiority", desc: "Attacks from above." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 7, al: 2 }, weapons: [{name: "Starfire Caster", atk: 4, acc: "4+", rng: 12, pwr: "4/5", sr: "Align 1"}, {name: "Sky Pistol", atk: 4, acc: "4+", rng: 8, pwr: "2/4", sr: "-"}, {name: "Wind Rapier", atk: 4, acc: "4+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            { id: "gunner_windstorm", name: "Aerial Gunner (Windstorm)*", role: "Operative", tags: ["Gunner"], ability: { name: "Aerial Superiority", desc: "Attacks from above." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 7, al: 2 }, weapons: [{name: "Windstorm Burner", atk: 4, acc: "2+", rng: 6, pwr: "3/4", sr: "-"}, {name: "Sky Pistol", atk: 4, acc: "4+", rng: 8, pwr: "2/4", sr: "-"}, {name: "Wind Rapier", atk: 4, acc: "4+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            { id: "gunner_skypierce", name: "Aerial Gunner (Skypierce)*", role: "Operative", tags: ["Gunner"], ability: { name: "Aerial Superiority", desc: "Attacks from above." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 7, al: 2 }, weapons: [{name: "Skypierce Lance", atk: 4, acc: "4+", rng: 6, pwr: "6/7", sr: "-"}, {name: "Sky Pistol", atk: 4, acc: "4+", rng: 8, pwr: "2/4", sr: "-"}, {name: "Wind Rapier", atk: 4, acc: "4+", rng: "Melee", pwr: "2/4", sr: "-"}] },
    ...
    "tinkerbright": {
        ...
        roster: [
            ...
            { id: "artillery_rockets", name: "Artillery Specialist (Rockets)*", role: "Operative", tags: ["Gunner"], ability: { name: "Versatile", desc: "Choose Prototype Rockets." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 5, al: 2 }, weapons: [{name: "Prototype Rockets", atk: 4, acc: "4+", rng: 12, pwr: "2/5", sr: "Blast 2"}, {name: "Tech Rifle", atk: 4, acc: "4+", rng: 10, pwr: "3/4", sr: "-"}, {name: "Shock Baton", atk: 4, acc: "4+", rng: "Melee", pwr: "3/4", sr: "-"}] },
            { id: "artillery_plasma", name: "Artillery Specialist (Plasma)*", role: "Operative", tags: ["Gunner"], ability: { name: "Versatile", desc: "Choose Sparkstream Projector." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 5, al: 2 }, weapons: [{name: "Sparkstream Projector", atk: 4, acc: "4+", rng: 12, pwr: "4/5", sr: "Align 1"}, {name: "Tech Rifle", atk: 4, acc: "4+", rng: 10, pwr: "3/4", sr: "-"}, {name: "Shock Baton", atk: 4, acc: "4+", rng: "Melee", pwr: "3/4", sr: "-"}] },
            { id: "artillery_melta", name: "Artillery Specialist (Melta)*", role: "Operative", tags: ["Gunner"], ability: { name: "Versatile", desc: "Choose Cogforge Melter." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 5, al: 2 }, weapons: [{name: "Cogforge Melter", atk: 4, acc: "4+", rng: 8, pwr: "6/7", sr: "-"}, {name: "Tech Rifle", atk: 4, acc: "4+", rng: 10, pwr: "3/4", sr: "-"}, {name: "Shock Baton", atk: 4, acc: "4+", rng: "Melee", pwr: "3/4", sr: "-"}] },
    ...
    "thornlings": {
        ...
        roster: [
            { id: "goldtooth", name: "Boss", role: "Leader", tags: ["Leader"], ability: { name: "Treasure Hoarder", desc: "You successfully find treasure on a 3+ (instead of a 4+)" }, special: { name: "Command", cost: "0", desc: "Once per battle, during this operative's activation, for free, you can command a friendly operative from your faction to complete 1 free Generic Action. If that action would make that friendly unit move, it can only move a maximum of 2 hexes." }, stats: { hp: 7, def: 4, acc: "4+", move: 6, al: 2 }, weapons: [{name: "Scrap Pistol", atk: 4, acc: "4+", rng: 10, pwr: "2/4", sr: "-"}, {name: "Rusty Blade", atk: 4, acc: "4+", rng: "Melee", pwr: "4/5", sr: "-"}] },

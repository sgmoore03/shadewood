const factionData = {
    ...
    "bloodthorn": {
        ...
        roster: [
            ...
            },
            {
                ...
                special: null,
                stats: { hp: 10, def: 5, acc: "4+", move: 5, al: 2 },
                weapons: [ { name: "Bloodfire Plasma", atk: 4, acc: "4+", rng: "12", pwr: "4/5", sr: "Align 1" }, { name: "Crimson Launcher", atk: 4, acc: "4+", rng: "12", pwr: "2/5", sr: "Blast 2" }, { name: "Sanguine Blade", atk: 4, acc: "4+", rng: "Melee", pwr: "2/4", sr: "-" } ]
            },
            {
    ...
    "skydancers": {
        ...
        comp: {
            leaders: "Choose 1",
            operatives: "Choose 6. Only 2 Gunners total may be selected."
        },
        roster: [
            { id: "starwing", name: "Queen Starwing", role: "Leader", tags: ["Leader"], ability: { name: "Wings of Freedom", desc: "Friendly Skydancer operatives can teleport between fairy rings without spending an Action Point (this still counts as a major movement)." }, special: { name: "Command", cost: "0", desc: "Once per battle, during this operative's activation, for free, you can command a friendly operative from your faction to complete 1 free Generic Action. If that action would make that friendly unit move, it can only move a maximum of 2 hexes." }, stats: { hp: 7, def: 4, acc: "4+", move: 7, al: 2 }, weapons: [{name: "Sky Rifle", atk: 4, acc: "4+", rng: 12, pwr: "2/4", sr: "-"}, {name: "Wind Rapier", atk: 4, acc: "4+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            { id: "moonwhisper", name: "Prince Moonwhisper", role: "Leader", tags: ["Leader"], ability: { name: "Precision Guidance", desc: "All Sky Pistols and Sky Rifles used by friendly Skydancer operatives gain Align 1" }, special: { name: "Command", cost: "0", desc: "Once per battle, during this operative's activation, for free, you can command a friendly operative from your faction to complete 1 free Generic Action. If that action would make that friendly unit move, it can only move a maximum of 2 hexes." }, stats: { hp: 7, def: 4, acc: "4+", move: 7, al: 2 }, weapons: [{name: "Sky Rifle", atk: 4, acc: "4+", rng: 12, pwr: "2/4", sr: "-"}, {name: "Wind Rapier", atk: 4, acc: "4+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            { id: "gunner", name: "Aerial Gunner", role: "Operative", tags: ["Gunner"], ability: { name: "Aerial Superiority", desc: "Attacks from above." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 7, al: 2 }, weapons: [{name: "Starfire Caster", atk: 4, acc: "4+", rng: 12, pwr: "4/5", sr: "Align 1"}, {name: "Windstorm Burner", atk: 4, acc: "2+", rng: 6, pwr: "3/4", sr: "-"}, {name: "Skypierce Lance", atk: 4, acc: "4+", rng: 6, pwr: "6/7", sr: "-"}, {name: "Sky Pistol", atk: 4, acc: "4+", rng: 8, pwr: "2/4", sr: "-"}, {name: "Wind Rapier", atk: 4, acc: "4+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            { id: "sniper", name: "Windrider Sniper", role: "Operative", tags: ["Sniper"], ability: { name: "Roll", desc: "After shooting with the stationary profile, this unit may move 1 hex for free." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 7, al: 2 }, weapons: [{name: "Whisperwind (Stationary)", atk: 4, acc: "2+", rng: 16, pwr: "3/6", sr: "Stationary"}, {name: "Whisperwind", atk: 4, acc: "3+", rng: 12, pwr: "3/5", sr: "-"}, {name: "Sky Pistol", atk: 4, acc: "4+", rng: 8, pwr: "2/4", sr: "-"}, {name: "Wind Rapier", atk: 4, acc: "4+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            { id: "scout", name: "Windcaller Scout", role: "Operative", tags: ["Spotter"], ability: { name: "Spotter", desc: "Identifies targets." }, special: { name: "Spot", cost: "1", desc: "Selects a visible enemy target to be spotted. When a friendly unit within 3 hexes of this unit is shooting a spotted enemy, its shooting weapons get lethal 5+. An enemy is no longer spotted if it's currently not visible to this unit, or until one of the following happens:\n- This unit is killed\n- This unit uses this action again\n- The next time this operative activates" }, stats: { hp: 7, def: 4, acc: "4+", move: 7, al: 2 }, weapons: [{name: "Sky Rifle", atk: 4, acc: "4+", rng: 12, pwr: "2/4", sr: "-"}, {name: "Wind Rapier", atk: 4, acc: "4+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            { id: "shaman", name: "Wind Shaman", role: "Operative", tags: ["Spirit Healer"], ability: { name: "Healer", desc: "Supports with magic." }, special: { name: "Ancestral Mending", cost: "1", desc: "Select a friendly unit within 6 hexes. For the next (2d3 + 2) activations, heal that friendly unit for 1 health.\n*Note: The friendly unit only needs to be within 6 hexes when this ability is cast.*" }, stats: { hp: 7, def: 4, acc: "4+", move: 7, al: 2 }, weapons: [{name: "Sky Rifle", atk: 4, acc: "4+", rng: 12, pwr: "2/4", sr: "-"}, {name: "Wind Rapier", atk: 4, acc: "4+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            { id: "warden", name: "Ring Warden", role: "Operative", tags: ["Comms Specialist"], ability: { name: "Defense Beacon", desc: "This operative counts as 1 additional AL when determining control of a mission or objective marker. This is not a change to this operative's AL stat." }, special: { name: "Relay Orders", cost: "1", desc: "Give a friendly unit within 6 hexes an additional Action Limit until the end of their next activation." }, stats: { hp: 7, def: 4, acc: "4+", move: 7, al: 2 }, weapons: [{name: "Sky Rifle", atk: 4, acc: "4+", rng: 12, pwr: "2/4", sr: "-"}, {name: "Wind Rapier", atk: 4, acc: "4+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            { id: "guardian", name: "Sky Guardian", role: "Operative", tags: ["Generic Warrior"], ability: { name: "Ring Guard", desc: "While this operative is within REACH of a friendly fairy ring token, It's Sky Rifle gets +1/+1 power." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 7, al: 2 }, weapons: [{name: "Sky Rifle", atk: 4, acc: "4+", rng: 12, pwr: "2/4", sr: "-"}, {name: "Wind Rapier", atk: 4, acc: "4+", rng: "Melee", pwr: "2/4", sr: "-"}] }
        ]
    },
    ...
    "rotcallers": {
        ...
        roster: [
            { id: "patriarch", name: "Patriarch Sporeheart", role: "Leader", tags: ["Leader"], ability: { name: "Spreading Rot", desc: "Death bloom tokens placed by friendly Rotcaller operatives have their range increased by 1 hex (e.g., on turn 2, the range is 4 hexes instead of 3)." }, special: { name: "Command", cost: "0", desc: "Once per battle, during this operative's activation, for free, you can command a friendly operative from your faction to complete 1 free Generic Action. If that action would make that friendly unit move, it can only move a maximum of 2 hexes." }, stats: { hp: 10, def: 5, acc: "3+", move: 6, al: 2 }, weapons: [{name: "Spore Rifle", atk: 4, acc: "3+", rng: 10, pwr: "3/5", sr: "-"}, {name: "Fungal Fists", atk: 4, acc: "3+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            { id: "mycelord", name: "Mycelord Blightcap", role: "Leader", tags: ["Leader"], ability: { name: "Fungal Fortitude", desc: "All friendly Rotcaller operatives get +2 HP." }, special: { name: "Command", cost: "0", desc: "Once per battle, during this operative's activation, for free, you can command a friendly operative from your faction to complete 1 free Generic Action. If that action would make that friendly unit move, it can only move a maximum of 2 hexes." }, stats: { hp: 10, def: 5, acc: "3+", move: 6, al: 2 }, weapons: [{name: "Spore Rifle", atk: 4, acc: "3+", rng: 10, pwr: "3/5", sr: "-"}, {name: "Fungal Fists", atk: 4, acc: "3+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            { id: "heavy", name: "Sporebearer Heavy", role: "Operative", tags: ["Heavy Gunner"], ability: { name: "Modifier", desc: "This operative has -1 Move Stat (to a minimum of 5)." }, special: null, stats: { hp: 10, def: 5, acc: "3+", move: 5, al: 2 }, weapons: [{name: "Spore Sprayer", atk: 4, acc: "3+", rng: 10, pwr: "5/6", sr: "-"}, {name: "Spore Rifle", atk: 4, acc: "3+", rng: 10, pwr: "3/5", sr: "-"}, {name: "Fungal Fists", atk: 4, acc: "3+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            { id: "warden", name: "Bloom Warden", role: "Operative", tags: ["Spotter", "Comms Specialist"], ability: { name: "Defense Beacon", desc: "This operative counts as 1 additional AL when determining control of a mission or objective marker. This is not a change to this operative's AL stat." }, special: { name: "Spot", cost: "1", desc: "Selects a visible enemy target to be spotted. When a friendly unit within 3 hexes of this unit is shooting a spotted enemy, its shooting weapons get lethal 5+. An enemy is no longer spotted if it's currently not visible to this unit, or until one of the following happens:\n- This unit is killed\n- This unit uses this action again\n- The next time this operative activates" }, stats: { hp: 10, def: 5, acc: "3+", move: 6, al: 2 }, weapons: [{name: "Spore Rifle", atk: 4, acc: "3+", rng: 10, pwr: "3/5", sr: "-"}, {name: "Fungal Fists", atk: 4, acc: "3+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            { id: "engineer", name: "Decay Engineer", role: "Operative", tags: ["Tech Specialist", "Gunner (Flamer)"], ability: { name: "Got a Plan", desc: "This operative can use this ability to perform one mission or objective action for free, during its activation." }, special: null, stats: { hp: 10, def: 5, acc: "3+", move: 6, al: 2 }, weapons: [{name: "Blight Burner", atk: 4, acc: "2+", rng: 6, pwr: "3/4", sr: "-"}, {name: "Spore Rifle", atk: 4, acc: "3+", rng: 10, pwr: "3/5", sr: "-"}, {name: "Fungal Fists", atk: 4, acc: "3+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            { id: "sniper", name: "Rot Sniper", role: "Operative", tags: ["Sniper"], ability: { name: "Roll", desc: "After shooting with the stationary profile, this unit may move 1 hex for free." }, special: null, stats: { hp: 10, def: 5, acc: "3+", move: 6, al: 2 }, weapons: [{name: "Rot Sniper (Stationary)", atk: 4, acc: "2+", rng: 16, pwr: "3/6", sr: "Stationary"}, {name: "Rot Sniper", atk: 4, acc: "3+", rng: 12, pwr: "3/5", sr: "-"}, {name: "Fungal Fists", atk: 4, acc: "3+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            { id: "medic", name: "Fungal Medic", role: "Operative", tags: ["Medic"], ability: { name: "Revive", desc: "Once per Turning Point, whenever a friendly unit within 3 hexes would drop below 1 health from any damage that is not from melee, set that friendly unit's health to 1 after the action is complete." }, special: { name: "Bandage", cost: "1", desc: "Heal a friendly unit within 2 hexes for d3 + 2. This can't be used on a friendly unit that has been revived this turn." }, stats: { hp: 10, def: 5, acc: "3+", move: 6, al: 2 }, weapons: [{name: "Spore Rifle", atk: 4, acc: "3+", rng: 10, pwr: "3/5", sr: "-"}, {name: "Fungal Fists", atk: 4, acc: "3+", rng: "Melee", pwr: "2/4", sr: "-"}] },
            { id: "warrior", name: "Rot Warrior", role: "Operative", tags: ["Generic Warrior"], ability: { name: "Bloom Empowerment", desc: "When this operative is on a friendly death bloom, its Spore Rifle gains Critical 5." }, special: null, stats: { hp: 10, def: 5, acc: "3+", move: 6, al: 2 }, weapons: [{name: "Spore Rifle", atk: 4, acc: "3+", rng: 10, pwr: "3/5", sr: "-"}, {name: "Fungal Fists", atk: 4, acc: "3+", rng: "Melee", pwr: "2/4", sr: "-"}] }
        ]
    },
    ...
    "tinkerbright": {
        ...
        roster: [
            { id: "engineer", name: "Chief Battle Engineer", role: "Leader", tags: ["Leader"], ability: { name: "Perfected Portals", desc: "Whenever a friendly Tinkerbright operative uses a teleportation pad, all their weapons gain Critical 5+ until the end of their activation." }, special: { name: "Command", cost: "0", desc: "Once per battle, during this operative's activation, for free, you can command a friendly operative from your faction to complete 1 free Generic Action. If that action would make that friendly unit move, it can only move a maximum of 2 hexes." }, stats: { hp: 7, def: 4, acc: "4+", move: 5, al: 2 }, weapons: [{name: "Tech Rifle", atk: 4, acc: "4+", rng: 10, pwr: "3/4", sr: "-"}, {name: "Shock Baton", atk: 4, acc: "4+", rng: "Melee", pwr: "3/4", sr: "-"}] },
            ...
            { id: "assassin", name: "Teleport Assassin", role: "Operative", tags: ["Blademaster"], ability: { name: "Skilled Fighter", desc: "Has +3 DEF against melee attacks." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 5, al: 2 }, weapons: [{name: "Tech Pistol", atk: 4, acc: "4+", rng: 8, pwr: "3/4", sr: "-"}, {name: "Shock Baton", atk: 4, acc: "4+", rng: "Melee", pwr: "4/5", sr: "-"}] },
            { id: "heavy", name: "Heavy Weapons Specialist", role: "Operative", tags: ["Heavy Gunner"], ability: { name: "Modifier", desc: "This operative has -1 Move Stat (to a minimum of 5)." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 4, al: 2 }, weapons: [{name: "Gnomish Gatling", atk: 4, acc: "4+", rng: 10, pwr: "5/6", sr: "-"}, {name: "Tech Rifle", atk: 4, acc: "4+", rng: 10, pwr: "3/4", sr: "-"}, {name: "Shock Baton", atk: 4, acc: "4+", rng: "Melee", pwr: "3/4", sr: "-"}] },
            { id: "artillery", name: "Artillery Specialist", role: "Operative", tags: ["Gunner"], ability: { name: "Versatile", desc: "Choose Prototype Rockets, Sparkstream Projector, or Cogforge Melter." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 5, al: 2 }, weapons: [{name: "Prototype Rockets", atk: 4, acc: "4+", rng: 12, pwr: "2/5", sr: "Blast 2"}, {name: "Sparkstream Projector", atk: 4, acc: "4+", rng: 12, pwr: "4/5", sr: "Align 1"}, {name: "Cogforge Melter", atk: 4, acc: "4+", rng: 8, pwr: "6/7", sr: "-"}, {name: "Tech Rifle", atk: 4, acc: "4+", rng: 10, pwr: "3/4", sr: "-"}, {name: "Shock Baton", atk: 4, acc: "4+", rng: "Melee", pwr: "3/4", sr: "-"}] },
            { id: "technician", name: "Field Technician", role: "Operative", tags: ["Tech Specialist"], ability: { name: "Got a Plan", desc: "This operative can use this ability to perform one mission or objective action for free, during its activation." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 5, al: 2 }, weapons: [{name: "Tech Rifle", atk: 4, acc: "4+", rng: 10, pwr: "3/4", sr: "-"}, {name: "Shock Baton", atk: 4, acc: "4+", rng: "Melee", pwr: "3/4", sr: "-"}] },
            { id: "medic", name: "Engineer Medic", role: "Operative", tags: ["Medic"], ability: { name: "Revive", desc: "Once per Turning Point, whenever a friendly unit within 3 hexes would drop below 1 health from any damage that is not from melee, set that friendly unit's health to 1 after the action is complete." }, special: { name: "Bandage", cost: "1", desc: "Heal a friendly unit within 2 hexes for d3 + 2. This can't be used on a friendly unit that has been revived this turn." }, stats: { hp: 7, def: 4, acc: "4+", move: 5, al: 2 }, weapons: [{name: "Tech Rifle", atk: 4, acc: "4+", rng: 10, pwr: "3/4", sr: "-"}, {name: "Shock Baton", atk: 4, acc: "4+", rng: "Melee", pwr: "3/4", sr: "-"}] },
            { id: "comms", name: "Comms Operator", role: "Operative", tags: ["Comms Specialist"], ability: { name: "Defense Beacon", desc: "This operative counts as 1 additional AL when determining control of a mission or objective marker. This is not a change to this operative's AL stat." }, special: { name: "Relay Orders", cost: "1", desc: "Give a friendly unit within 6 hexes an additional Action Limit until the end of their next activation." }, stats: { hp: 7, def: 4, acc: "4+", move: 5, al: 2 }, weapons: [{name: "Tech Rifle", atk: 4, acc: "4+", rng: 10, pwr: "3/4", sr: "-"}, {name: "Shock Baton", atk: 4, acc: "4+", rng: "Melee", pwr: "3/4", sr: "-"}] },
            { id: "trooper", name: "Tech Trooper", role: "Operative", tags: ["Generic Warrior"], ability: { name: "Emergency Teleport", desc: "Once per battle, after this operative is targeted by a shooting attack (but before dice are rolled), this operative may immediately use a friendly teleportation pad within 6 hexes, moving 5 hexes in any direction through the pad. The attack is then resolved against the operative's new position." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 5, al: 2 }, weapons: [{name: "Tech Rifle", atk: 4, acc: "4+", rng: 10, pwr: "3/4", sr: "-"}, {name: "Shock Baton", atk: 4, acc: "4+", rng: "Melee", pwr: "3/4", sr: "-"}] }
        ]
    },
    ...
    "thornlings": {
        ...
        radar: [3, 4, 5, 5, 6],
        teamRule: { name: "Treasure!", desc: "Whenever a Goblin performs a mission action or the \"Look for Treasure\" action, roll a d6: on a 4+, you find a treasure token. The amount of treasure tokens you're holding can give buffs:\n\n| Tokens | Buff |\n|---|---|\n| 2+ | When shooting or fighting, friendly goblins get to re-roll 1 attack dice |\n| 4+ | All weapons get Crit 5+ |\n| 6+ | Your Faction gets +3 DEF |\n| 8+ | Add +1 Damage to all Power |\n| 10+ | When shooting or fighting, friendly goblins get to re-roll any attack dice |\n\n### Special Action: Look for Treasure\nUntil you move next, this unit has +1 DEF. This action cannot be performed within your drop zone." },
        comp: {
            leaders: "Choose 1",
            operatives: "Choose 5"
        },
        roster: [
            { id: "goldtooth", name: "Boss Goldtooth", role: "Leader", tags: ["Leader"], ability: { name: "Treasure Hoarder", desc: "You successfully find treasure on a 3+ (instead of a 4+)" }, special: { name: "Command", cost: "0", desc: "Once per battle, during this operative's activation, for free, you can command a friendly operative from your faction to complete 1 free Generic Action. If that action would make that friendly unit move, it can only move a maximum of 2 hexes." }, stats: { hp: 7, def: 4, acc: "4+", move: 6, al: 2 }, weapons: [{name: "Scrap Pistol", atk: 4, acc: "4+", rng: 10, pwr: "2/4", sr: "-"}, {name: "Rusty Blade", atk: 4, acc: "4+", rng: "Melee", pwr: "4/5", sr: "-"}] },
            { id: "shinygrab", name: "Chieftain Shinygrab", role: "Leader", tags: ["Leader"], ability: { name: "Safety in Numbers", desc: "All friendly Thornling units get" }, special: { name: "Command", cost: "0", desc: "Once per battle, during this operative's activation, for free, you can command a friendly operative from your faction to complete 1 free Generic Action. If that action would make that friendly unit move, it can only move a maximum of 2 hexes." }, stats: { hp: 7, def: 4, acc: "4+", move: 6, al: 2 }, weapons: [{name: "Scrap Pistol", atk: 4, acc: "4+", rng: 10, pwr: "2/4", sr: "-"}, {name: "Rusty Blade", atk: 4, acc: "4+", rng: "Melee", pwr: "4/5", sr: "-"}] },
            { id: "guard", name: "Treasure Guard", role: "Operative", tags: ["Blademaster"], ability: { name: "Skilled Fighter", desc: "Has +3 DEF against melee attacks." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 6, al: 2 }, weapons: [{name: "Scrap Pistol", atk: 4, acc: "4+", rng: 10, pwr: "2/4", sr: "-"}, {name: "Rusty Hatchet", atk: 4, acc: "4+", rng: "Melee", pwr: "4/5", sr: "-"}] },
            { id: "gunner", name: "Scrap Gunner", role: "Operative", tags: ["Gunner (Flamer)", "Grenadier (Frag)"], ability: { name: "Explosives", desc: "Uses Blast weapons." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 6, al: 2 }, weapons: [{name: "Junk Burner", atk: 4, acc: "2+", rng: 6, pwr: "3/4", sr: "-"}, {name: "Boom Sticks", atk: 4, acc: "3+", rng: 6, pwr: "2/4", sr: "Blast 2"}, {name: "Scrap Pistol", atk: 4, acc: "4+", rng: 10, pwr: "2/4", sr: "-"}, {name: "Rusty Blade", atk: 4, acc: "4+", rng: "Melee", pwr: "4/5", sr: "-"}] },
            { id: "sniper", name: "Loot Sniper", role: "Operative", tags: ["Sniper"], ability: { name: "Roll", desc: "After shooting with the stationary profile, this unit may move 1 hex for free." }, special: null, stats: { hp: 7, def: 4, acc: "4+", move: 6, al: 2 }, weapons: [{name: "Loot Rifle (Stationary)", atk: 4, acc: "2+", rng: 16, pwr: "3/6", sr: "Stationary"}, {name: "Loot Rifle", atk: 4, acc: "3+", rng: 12, pwr: "3/5", sr: "-"}, {name: "Scrap Pistol", atk: 4, acc: "4+", rng: 10, pwr: "2/4", sr: "-"}, {name: "Rusty Blade", atk: 4, acc: "4+", rng: "Melee", pwr: "4/5", sr: "-"}] },
            { id: "medic", name: "Goblin Medic", role: "Operative", tags: ["Medic"], ability: { name: "Revive", desc: "Once per Turning Point, whenever a friendly unit within 3 hexes would drop below 1 health from any damage that is not from melee, set that friendly unit's health to 1 after the action is complete." }, special: { name: "Bandage", cost: "1", desc: "Heal a friendly unit within 2 hexes for d3 + 2. This can't be used on a friendly unit that has been revived this turn." }, stats: { hp: 7, def: 4, acc: "4+", move: 6, al: 2 }, weapons: [{name: "Scrap Pistol", atk: 4, acc: "4+", rng: 10, pwr: "2/4", sr: "-"}, {name: "Rusty Blade", atk: 4, acc: "4+", rng: "Melee", pwr: "4/5", sr: "-"}] },
            { id: "seeker", name: "Fortune Seeker", role: "Operative", tags: ["Tech Specialist", "Spotter"], ability: { name: "Got a Plan", desc: "This operative can use this ability to perform one mission or objective action for free, during its activation." }, special: { name: "Spot", cost: "1", desc: "Selects a visible enemy target to be spotted. When a friendly unit within 3 hexes of this unit is shooting a spotted enemy, its shooting weapons get lethal 5+. An enemy is no longer spotted if it's currently not visible to this unit, or until one of the following happens:\n- This unit is killed\n- This unit uses this action again\n- The next time this operative activates" }, stats: { hp: 7, def: 4, acc: "4+", move: 6, al: 2 }, weapons: [{name: "Scrap Pistol", atk: 4, acc: "4+", rng: 10, pwr: "2/4", sr: "-"}, {name: "Rusty Blade", atk: 4, acc: "4+", rng: "Melee", pwr: "4/5", sr: "-"}] },
            { id: "defender", name: "Hoard Defender", role: "Operative", tags: ["Comms Specialist"], ability: { name: "Defense Beacon", desc: "This operative counts as 1 additional AL when determining control of a mission or objective marker. This is not a change to this operative's AL stat." }, special: { name: "Relay Orders", cost: "1", desc: "Give a friendly unit within 6 hexes an additional Action Limit until the end of their next activation." }, stats: { hp: 7, def: 4, acc: "4+", move: 6, al: 2 }, weapons: [{name: "Scrap Pistol", atk: 4, acc: "4+", rng: 10, pwr: "2/4", sr: "-"}, {name: "Rusty Blade", atk: 4, acc: "4+", rng: "Melee", pwr: "4/5", sr: "-"}] },
